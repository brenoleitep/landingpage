...
import astronaut from "../Lotties/laptop3.json";
      ...
      <StyledPassaporteDiv>
        <StyledDivPass>
          ...
          <p data-aos="fade-in">
            ...
            tantos recursos ou não confia em contratar uma equipe para te ajudar
            no lançamento e vive o dilema de querer viver do digital mas tem
            medo de arriscar tudo que você tem?
          </p>

          <p data-aos="fade-in">
            Não se preocupe que não é só você que vive esse terrível dilema,
            infelizmente as atuais estratégias de lançamento não foram pensadas
            para pessoas como você.
          </p>

          <p data-aos="fade-in">
            Se você pegar estratégias atuais e pagar em média de 5 a 7 mil, você
            vai perceber que é impossível você conseguir vender seu infoproduto
            sem ter uma equipe ou fazer parceria com um lançador.
          </p>
          ...
          <p data-aos="fade-in">
            ...
            um copyright, um webdesigner e outras pessoas para conseguir colocar
            em prática?
          </p>
        </StyledDivPass>
        <StyledLottiePass>
